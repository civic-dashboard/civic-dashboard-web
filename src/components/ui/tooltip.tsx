...
export function Tooltip({
  ...
  tooltipContent,
  tooltipTitle,
  delayDuration = 100, // Faster default delay (100ms instead of 700ms)
}: TooltipProps) {
  ...
  return (
    ...
    >
      <TooltipPrimitive.Trigger
        asChild
        onPointerDown={(e) => {
          // Prevent parent link/card navigations from firing
          e.preventDefault();
          e.stopPropagation();
        }}
        onClick={(e) => {
          // Always prevent default navigation and stop propagation so tooltips work inside links
          e.preventDefault();
          e.stopPropagation();
          setIsOpen(true);
        }}
