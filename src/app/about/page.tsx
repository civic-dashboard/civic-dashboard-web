      ...
      <Section>
        ...
        <BulletedList>
          <li>
            ...
            (municipal/provincial) government and what you can do about it
          ...
          <li>
            Democratic engagement should be a clear, actionable, meaningful, and
            satisfying response to wanting to see a change in the place you
            live. It should be at least as good an option as stewing in
            frustration, or ranting to a friend, or tweeting, or just plain old
            apathy.
          </li>
        </BulletedList>
        <div className="space-y-6">
          <p>
            ...
            more widely, will be more representative of our city's population
            and its desires, will be engaged with far more often than just
      ...
      <Section>
        ...
        <BulletedList>
          <li>
            ...
            one ever will. This is made by people who care and come together, so
            that people can more easily care and come together, for the benefit
            of all.
          </li>
          <li>
            We keep costs low, we use volunteer labour, and we are thoughtful
            and self-critical about the pressures and incentives we exist under.
            We're building this as long-term critical public infrastructure -
            thoughtfully, prioritizing public input and stability, and without
            profit in mind.
          </li>
          <li>
        ...
        <BulletedList>
          ...
          <li>
            <ExternalLink
              ...
              className="classic-link"
            >
              Our communications and action items (in the #proj-civic-dashboard
              channel)
            </ExternalLink>
          </li>
        </BulletedList>
        ...
        <BulletedList>
          ...
          <li>
            An oversight on the part of our incredible, but human and therefore
            fallible, team
          </li>
        </BulletedList>
        <p>
        ...
        <p>
          ...
          session series that hasn't missed a Tuesday in almost a decade! If
          you're interested in learning more about projects like this one, the
          civic technology space, and meeting folks passionate about it in
          Toronto, come to one of the{' '}
          <ExternalLink
