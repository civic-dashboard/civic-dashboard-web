...
export const metadata: Metadata = { title: 'Privacy Policy – Civic Dashboard' };

export default function Privacy() {
  return (
    <ArticlePage>
      <Section>
        <Text preset="Heading1">Privacy Policy</Text>
        <Text preset="Body">
      ...
      <Section>
        <Text preset="Heading2">
          Data you submit to us for our features to work
        </Text>
        <Text preset="Body">
      ...
      <Section>
        <Text preset="Heading2">
          Data we collect to help us improve Civic Dashboard
        </Text>
        <Text preset="Body">
      ...
      <Section>
        <Text preset="Heading2">Full list of 3rd party providers</Text>
        <Text preset="Body">
