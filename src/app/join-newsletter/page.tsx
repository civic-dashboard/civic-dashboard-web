...
export default function JoinNewsletter() {
  return (
    <>
    <Script src="https://steadyhq.com/widget_loader/c39a8289-1099-4fff-befe-44e30f48e9ba" strategy="lazyOnload"></Script>
        ...
        <main className="flex-grow flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
          <div className="max-w-3xl mx-auto px-4 py-16 text-center">
            <div className="space-y-8">
              ...
              We’re building this project out in the open—and you’re invited to be part of it.<br/><br/>
              Subscribe for occasional updates on what we’re working on, what we’re learning, and where we need your input. From behind-the-scenes reflections to feature updates and community calls-to-action, you’ll get it all in your inbox.<br/><br/>
              </p>
