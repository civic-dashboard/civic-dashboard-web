/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 2083221e1551635489ab621b5f52a931)
// Runtime types generated with workerd@1.20250913.0 2025-05-05 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		DATABASE_URL: string;
		RESEND_API_KEY: string;
		CRON_SECRET: string;
		HOSTNAME_FOR_EMAIL_LINKS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "RESEND_API_KEY" | "CRON_SECRET" | "HOSTNAME_FOR_EMAIL_LINKS">> {}
}
